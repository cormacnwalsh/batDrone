...
exports.getHandContour = (handMask) => {
...
exports.getRoughHull = (contour, maxDist) => {
...
exports.getHullDefectVertices = (handContour, hullIndices) => {
...
exports.filterVerticesByAngle = (vertices, maxAngleDeg) =>
  vertices.filter((v) => {
    const sq = x => x * x;
